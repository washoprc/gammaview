/*
    GAMMA Viewer - NormalFilter12 : Filter for 12-bit port
    ...
    GAMMA Viewer - NormalFilter12 : １２ビットポート用フィルター
...
public class NormalFilter12 implements AbstractFilter
{
  //-----------------------------------------
  /*  Fields  */
  //-----------------------------------------

  String FilterName = "NormalFilter(12bit)";
  ...
  public double[] applyFilter( PortInfomation autoPortInfo, Vector autoRawData )
  {
    ...
    final double autoDataSizeBit = 4095.0;
  ...
  // FOR DETAIL, See basic interface "AbstractFilter"
  //
  public String getDescription()     { return "通常の12bitのポートを扱います。"; }

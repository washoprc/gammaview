/*
    GAMMA Viewer - NormalFilter16 : Filter for 16-bit port
    ...
    GAMMA Viewer - NormalFilter16 : １６ビットポート用フィルター
...
public class NormalFilter16 implements AbstractFilter
{
  //-----------------------------------------
  /*  Fields  */
  //-----------------------------------------

  String FilterName = "NormalFilter(16bit)";
  ...
  public double[] applyFilter( PortInfomation autoPortInfo, Vector autoRawData )
  {
    ...
    final double autoDataSizeBit = 65535;
  ...
  // FOR DETAIL, See basic interface "AbstractFilter"
  //
  public String getDescription()     { return "通常の16bitのポートを扱います。"; }

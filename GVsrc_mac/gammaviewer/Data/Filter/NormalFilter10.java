/*
    GAMMA Viewer - NormalFilter10 : Filter for 10-bit port
    ...
    GAMMA Viewer - NormalFilter10 : １０ビットポート用フィルター
...
/**
 * <p>タイトル: GAMMA View second edition</p>
 * <p>説明: </p>
 * <p>著作権: Tsuda Eisuke</p>
 * <p>licence GPL</p>
 * @author Tsuda Eisuke
 * @version 0.0.1
 */

public class NormalFilter10 implements AbstractFilter
{
  //-----------------------------------------
  /*  Fields  */
  //-----------------------------------------

  String FilterName = "NormalFilter(10bit)";
//  String Description  = "Template class of all filters.";
  ...
  public double[] applyFilter( PortInfomation autoPortInfo, Vector autoRawData )
  {
    ...
    final double autoDataSizeBit = 1024.0;
  ...
  // FOR DETAIL, See basic interface "AbstractFilter"
  //
  public String getDescription()     { return "通常の10bitのポートを扱います。"; }
